...
/**
 * Created by Aman Jain on 04/12/15.
 */
            ...
            if (rippleDuration <= timer * frameRate) {
                ...
                if (onCompletionListener != null) {
                    ...
                    /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        float elevation = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16, getResources().getDisplayMetrics());
